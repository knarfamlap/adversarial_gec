...
def train_generator_MLE(gen, gen_opt, oracle, real_data_samples, epochs):
    ...
    for epoch in range(epochs):
        ...
        for i in range(0, POS_NEG_SAMPLES< BATCH_SIZE):
            inp, target = helpers.prepare_generator_batch(real_data_samples[i:i + BATCH_SZ], start_letter=START_LETTER, gpu=CUDA)
            gen_opt.zero_grad()
        ...
        oracle_loss = utils.batchwise_oracle_nll(gen, oracle, POS_NEG_SAMPLES, BATCH_SIZE, MAX_SEQ_LEN, start_letter=START_LETTER, gpu=CUDA) 
...
def train_generator_PG(gen, gen_opt, oracle, dis, num_batches):
    ...
    for batch in range(num_batches):
        ...
        inp, target = utils.prepare_generator_batch(s, start_letter=START, gpu=CUDA) 
    ...
    oracle_loss = utils.batchwise_oracle_nll(gen, oracle, POS_NEG_SAMPLES, start_letter=START_LETTER, gpu=CUDA) 
...
def train_discriminator(discriminator, dis_opt, real_data_samples, generator, oracle, d_steps, epochs):
    ...
    val_inp, val_target = utils.prepare_discriminator_data(pos_val, neg_val, gpu=CUDA) 


    for d_step in range(d_steps):
        s = helpers.batchwise_sample(generator, POS_NEG_SAMPLES, BATCH_SIZE)
        dis_inp, dis_target = utils.prepare_discriminator_data(real_data_samples, s, gpu=CUDA) 
